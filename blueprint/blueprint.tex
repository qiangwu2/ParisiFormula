...
and disorder. Signed initial Gaussian estimates and a construction retaining
the original shared field are checked. The signed pressure inequality,
completion of Proposition~5.4, the outside-neighbor case (Proposition~5.7),
and uniform assembly into Theorem~2.4 remain open.
...
\end{proof}
The signed initial and outside-neighbor cases, compactness, and the uniform
assembly into Theorem~2.4 are still open; the far-right case is proved below.
...
\end{proof}
These endpoint identities and scalar estimates do not alone prove
Proposition~5.4. The full signed pressure derivative, covariance inequality,
and endpoint transport remain to be connected. In particular, replacing the
retained positive shared field by a negative one is not an endpoint identity.
...
Complete the signed initial case (Proposition~5.4), the interleaved-mass
outside-neighbor construction (Proposition~5.7), and their compact-uniform
assembly. The scalar stationarity reduction is
