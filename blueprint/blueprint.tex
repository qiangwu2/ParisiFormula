...
\end{proof}
This interior identity does not yet give the higher mixed derivatives, endpoint
stationarity, or the remaining outer propagation needed in Section~4.
...
nevertheless $m_0=0$, and still needs its appropriate mass-variation treatment.
