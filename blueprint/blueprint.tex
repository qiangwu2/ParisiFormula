...
\end{proof}
Continuity of $Q$ at the baseline, the resulting identity $U'=Q$, and $U''$
...
\end{proof}
The simultaneous outer Gaussian derivative, replica-weight identification,
and endpoint-safe integration of the full second interpolation remain to be assembled.
...
\end{proof}
This does not yet pass the simultaneous derivative through the outer disorder
average or identify it with the replica covariance expression.
