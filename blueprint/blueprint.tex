...
Lemma~2.6 is not yet complete in the project's abstract disorder formulation:
the standard-coordinate expectations must still be identified with the law of
\texttt{sk.U} and the outer zero-mass average.
The remaining work follows Proposition~2.3 and the coupled-replica concentration
argument in \S3--\S5 of \cite{Tal06}: complete this change of law,
