...
and uniform first/second mass bounds are proved below; quantitative
optimality and the remaining stationarity estimates remain open.
...
first-variation identities give the expansion. This does not yet apply
scheme optimality or prove the quantitative improvement in Theorem~2.4.
\end{proof}
...
is proved above. Remaining endpoint stationarity conditions are still open.
