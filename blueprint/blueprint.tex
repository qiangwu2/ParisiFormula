...
estimates (Propositions~5.1 and~5.3) are checked. The dual and remaining
overlap/sign cases, and their uniform assembly into Theorem~2.4, remain open.
...
the local-left/initial quadratic estimates are now checked. The next step is
the dual local estimate, followed by the remaining terminal/far-overlap and
