...
also remain open. Lemma~5.8's identification with $U'$ remains open;
the uniform bound of Lemma~5.9 is now proved below.
...
\end{proof}
The identity for $U''$ and the remaining Lemma~5.8 comparison are still open,
as are uniform bounds on higher mass derivatives and optimality estimates.
...
\end{proof}
Replica-weight identification and endpoint-safe integration of the desired
