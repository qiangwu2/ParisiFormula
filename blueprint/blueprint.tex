...
identified with $\eta'$. The genuine full nested disorder/spatial Hessians
and disorder-averaged SK trace are now identified with actual replica weights
below. Combining the full trace and heat contributions still requires proof. Consequently
...
and uniform first mass bounds are proved below; the full nested second mass
bound and quantitative stationarity estimates remain open.
...
give the two nested first bounds. The full nested second derivative bound
in Lemma~4.5 is not yet proved.
\end{proof}
...
\end{proof}
The identity for $U''$ is proved below. The full nested second mass bound and
remaining endpoint stationarity conditions are still open.
...
No variance-endpoint second derivative or strictly negative bound is claimed.
\end{proof}
...
a derivative at zero variance. Contracting the field directions into overlaps,
averaging the heat terms and combining their physical coefficients with the
SK trace remain to be assembled.
\end{proof}
The full combined interpolation covariance identity and inequality remain open.
