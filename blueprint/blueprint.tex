...
\end{proof}
The nested mass estimates and Proposition~4.6 are proved below. Higher
variance regularity and the remaining stationarity cases are still open.
...
\end{proof}
Higher variance regularity and the remaining stationarity cases are open;
nonterminal endpoint stationarity is proved below.
...
proved below. The remaining stationarity cases and Proposition~4.10 are open.
...
\end{proof}
The final compulsory-mass level and coincident interior overlap levels
remain open. No stationarity assertion is made at $\beta=0$, where the
functional does not constrain the overlaps of arbitrary minimizers.
