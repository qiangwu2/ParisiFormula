...
are checked. The mixed-pressure inequality and uniform assembly into
...
modules. Proposition~5.7's mixed-pressure inequality remains open;
its tagged construction, strict scalar sorting and actual endpoints are checked below, as is the uniform
bound of Lemma~5.9.
...
Proposition~5.7 itself remains open. The actual mixed-pressure derivative
and closed-interval inequality between these endpoints are not supplied by
the one-cutoff pressure theorem. Its multi-level replica, heat and joint-path
identities still need a mixed-mode version. Generic arbitrary-direction
Gaussian parameter transport is available, but is not that full inequality.
The final trial interval, interval selection at breakpoints, and negative
cases whose absolute overlap is between neighboring indices still require
boundary/sign assembly. The separate physical-time-zero estimate above
already covers every attainable overlap.
...
Complete the actual mixed-pressure derivative/transport and all positive-time
