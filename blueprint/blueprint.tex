...
The adjacent trial indices are now joined at shared breakpoints by the
following checked scalar and tagged-sort identities; the remaining signed,
first-level and terminal domains still require assembly. No continuity is
asserted for the changing finite-size overlap constraint.
...
checked. The remaining work is the global all-region assembly into the single
quadratic Theorem~2.4 estimate.
