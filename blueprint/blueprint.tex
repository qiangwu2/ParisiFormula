...
to the original free energy are now checked. The final trial interval and
remaining first-level boundary cases of Proposition~5.7, followed by uniform
...
Proposition~5.7 itself remains open: the final trial interval and remaining
first-physical-level sign cases require boundary assembly. The separate
physical-time-zero estimate above already covers every attainable overlap.
The actual mixed-pressure inequality is now checked, not an assumed input.
