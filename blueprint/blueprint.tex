...
These are supporting results for the endpoint argument in (5.17), not a proof
of that equation for the new interpolation. The inserted level, modified
Gaussian variances, second-interpolation endpoint identifications, and
derivative bound of Theorem~3.1 remain open. In particular $P_0=2\varphi$
...
\end{proof}
This is a general recursion, not yet the specific interpolating scheme of
Theorem~3.1. The lambda derivative is proved at fixed masses; neither the
