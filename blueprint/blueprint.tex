...
zero first overlap and the terminal interval. The remaining overlap/sign
cases and uniform assembly into Theorem~2.4 remain open.
...
\end{proof}
The signed and remaining far-overlap cases, compactness, and the uniform
assembly into Theorem~2.4 are still open.
