...
> This archive preserves the step-by-step frontier recorded during the formalization.
> Unchecked boxes below describe what was open at that historical checkpoint; they are
> not the current project status. See [`ROADMAP.md`](ROADMAP.md) for the current roadmap.
